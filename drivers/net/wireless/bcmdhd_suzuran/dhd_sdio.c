 ...
 *
 * $Id: dhd_sdio.c 701450 2017-05-25 02:10:23Z $
 */
...
#else
	bcm_wlan_crash_reason(bus->dhd->crash_reason);
	bcm_wlan_ramdump(buf, bus->ramsize);
	memset(bus->dhd->crash_reason, 0 , sizeof(bus->dhd->crash_reason));
	MFREE(bus->dhd->osh, buf, bus->ramsize);
#endif /* CONFIG_BCM_WLAN_RAMDUMP */
	return 0;
}
#endif /* DHD_DEBUG */
