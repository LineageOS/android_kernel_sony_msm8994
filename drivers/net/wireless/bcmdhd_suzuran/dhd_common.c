 ...
 *
 * $Id: dhd_common.c 701450 2017-05-25 02:10:23Z $
 */
#include <typedefs.h>
#include <osl.h>
...
#ifdef DHD_DEBUG
#ifndef SRCBASE
#define SRCBASE        "drivers/net/wireless/bcmdhd_suzuran"
#endif
#define DHD_COMPILED "\nCompiled in " SRCBASE
#endif /* DHD_DEBUG */
...
dhd_arp_offload_set(dhd_pub_t * dhd, int arp_mode)
{
	...
	ret = dhd_iovar(dhd, 0, "arp_ol", (char *)&arp_mode, sizeof(arp_mode), NULL, 0, TRUE);
	ret = ret >= 0 ? 0 : ret;
	if (ret)
...
dhd_arp_offload_enable(dhd_pub_t * dhd, int arp_enable)
{
	...
	ret = dhd_iovar(dhd, 0, "arpoe", (char *)&arp_enable, sizeof(arp_enable), NULL, 0, TRUE);
	ret = ret >= 0 ? 0 : ret;
	if (ret)
...
dhd_ndo_remove_ip(dhd_pub_t *dhd, int idx)
{
	...
	ret = dhd_iovar(dhd, idx, "nd_hostip_clear", NULL, 0,
		NULL, 0, TRUE);
	if (ret)
